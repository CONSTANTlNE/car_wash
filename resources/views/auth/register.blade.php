...
<body class="min-h-screen font-sans antialiased flex items-center justify-center
    ...
    <div class="w-96 px-4">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <p class="text-sm text-[var(--color-muted-light)] dark:text-[var(--color-muted-dark)] mt-1">ანგარიშის შექმნა</p>
        </div>
        ...
        <div class="rounded-2xl border border-[var(--color-border-light)] dark:border-[var(--color-border-dark)]
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5 p-4">
                @csrf

                {{-- Email --}}
                <div class="p-4  mb-1">
                    <label for="email" class="block text-sm font-medium mb-1.5">მეილი</label>
                ...
                <div class="p-4  mb-1">
                    <label for="name" class="block text-sm font-medium mb-1.5">სახელი</label>
                    <input id="name" type="text" name="name" value="{{ old('name') }}"
                           ...
                           class="w-full rounded-xl px-4 py-2.5 text-sm
                                  ...
                                  placeholder:text-[var(--color-muted-light)] dark:placeholder:text-[var(--color-muted-dark)]
                                  outline-none focus:ring-2 focus:ring-[var(--color-brand-400)] focus:border-transparent
                                  @error('name') border-rose-400 dark:border-rose-600 @enderror"
                           placeholder="" />
                </div>
                ...
                <div class="p-4  mb-1">
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="password" class="text-sm font-medium">პაროლი</label>
                    </div>
                ...
                <div class="p-4 mb-1">
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="confirm_password" class="text-sm font-medium">გაიმეორეთ პაროლი</label>
                    </div>
